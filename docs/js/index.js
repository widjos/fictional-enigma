...
function Traducir(){
    var ta=document.getElementById(get_vent());
    var contenido=ta.value;//texto de vent actual
    //Aqui deberia de ir el metodo para obtener el resultado de la traduccion  
    //resultXML = xmlA.parse(contenido);
    alert("Ejecucion realizada");
    document.getElementById("quetzalolc-output").innerHTML  = `=> Su compilacion ha sido exitosa ,
